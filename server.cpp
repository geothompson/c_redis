...
static void stat_req(Conn *conn);
...
// The data structure for the key space. This is just a placeholder for ht
...
static int32_t do_request(
    const uint8_t *req, uint32_t reqlen, uint32_t *rescode, 
